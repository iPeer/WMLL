...
public class aus extends aut
{
    ...
    public aus(Minecraft minecraft)
    {
        f = 0;
        g = "";
        h = 0;
    ...
    public void a(float f1, boolean flag, int j, int i1)
    {
        ...
        vc vc1 = d.g.bK.f(3);
        if(d.y.W == 0 && vc1 != null && vc1.c == ank.bc.cw)
        {
            a(j1, k1);
        }
        if(!d.g.a(lq.k))
        ...
        if(!d.b.a())
        {
            ...
            b((j1 / 2 - 91 - 1) + rg1.c * 20, k1 - 22 - 1, 0, 22, 24, 22);
        ...
        if(d.y.X)
        {
            d.I.a("debug");
            GL11.glPushMatrix();
            aur1.a((new StringBuilder()).append("Minecraft 13w02a (").append(d.K).append(")").toString(), 2, 2, 0xffffff);
            aur1.a(d.m(), 2, 12, 0xffffff);
            aur1.a(d.n(), 2, 22, 0xffffff);
            aur1.a(d.p(), 2, 32, 0xffffff);
            aur1.a(d.o(), 2, 42, 0xffffff);
            ...
            b(aur1, (new StringBuilder()).append("f: ").append(k12).append(" (").append(q.c[k12]).append(") / ").append(ke.g(d.g.z)).toString(), 2, 88, 0xe0e0e0);
            if(d.e != null && d.e.f(i10, i11, l11))
            {
                aaj aaj1 = d.e.d(i10, l11);
                b(aur1, (new StringBuilder()).append("lc: ").append(aaj1.h() + 15).append(" b: ").append(aaj1.a(i10 & 0xf, l11 & 0xf, d.e.t()).y).append(" bl: ").append(aaj1.a(yy.b, i10 & 0xf, i11, l11 & 0xf)).append(" sl: ").append(aaj1.a(yy.a, i10 & 0xf, i11, l11 & 0xf)).append(" rl: ").append(aaj1.c(i10 & 0xf, i11, l11 & 0xf, 0)).toString(), 2, 96, 0xe0e0e0);
            }
            b(aur1, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d", new Object[] {
                Float.valueOf(d.g.ce.b()), Float.valueOf(d.g.ce.a()), Boolean.valueOf(d.g.E), Integer.valueOf(d.e.f(i10, l11))
            }), 2, 104, 0xe0e0e0);
            GL11.glPopMatrix();
            d.I.b();
        }
        if(h > 0)
        {
            ...
            if(k3 > 0)
            {
                ...
                aur1.b(g, -aur1.a(g) / 2, -4, j4 + (k3 << 24));
                GL11.glDisable(3042);
                GL11.glPopMatrix();
            }
            d.I.b();
        ...
        if(d.y.P.e && (!d.A() || d.g.a.c.size() > 1))
        {
            ...
            for(int l8 = 0; l8 < k4; l8++)
            {
                ...
                azv azv1 = (azv)list.get(l8);
                aur1.a(azv1.a, k9, j10, 0xffffff);
    ...
    private void d()
    {
        ...
        String s = bbk.c;
        aur1.a(s, j / 2 - aur1.a(s) / 2, byte0 - 10, 0xffffff);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        GL11.glBindTexture(3553, d.o.b("/gui/icons.png"));
    }
    ...
    private void a(int j, int i1)
    {
        ...
        bcc bcc1 = bcc.a;
        bcc1.b();
        bcc1.a(0.0D, i1, -90D, 0.0D, 1.0D);
        bcc1.a(j, i1, -90D, 1.0D, 1.0D);
        bcc1.a(j, 0.0D, -90D, 1.0D, 0.0D);
        bcc1.a(0.0D, 0.0D, -90D, 0.0D, 0.0D);
        bcc1.a();
    ...
    private void b(float f1, int j, int i1)
    {
        ...
        bcc bcc1 = bcc.a;
        bcc1.b();
        bcc1.a(0.0D, i1, -90D, f2, f5);
        bcc1.a(j, i1, -90D, f4, f5);
        bcc1.a(j, 0.0D, -90D, f4, f3);
        bcc1.a(0.0D, 0.0D, -90D, f2, f3);
        bcc1.a();
        GL11.glDepthMask(true);
        GL11.glEnable(2929);
        GL11.glEnable(3008);
    ...
    private void a(int j, int i1, int j1, float f1)
    {
        ...
        b.b(d.p, d.o, vc1, i1, j1);
        if(f2 > 0.0F)
        {
            GL11.glPopMatrix();
        }
        b.c(d.p, d.o, vc1, i1, j1);
    }
    ...
    public void a()
    {
        ...
        if(d.g != null)
        {
            ...
            if(l == null || vc1.c != l.c || !vc.a(vc1, l) || !vc1.g() && vc1.k() != l.k())
            {
                k = 40;
            } else
            if(k > 0)
