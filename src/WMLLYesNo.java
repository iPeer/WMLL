...
public class WMLLYesNo extends xa {

	protected WMLL wmll;
	protected xa parent;
	byte offset = -16;
	
	public WMLLYesNo(WMLL wmll, xa parent) {
		this.parent = parent;
		this.wmll = wmll;
	}
	...
	public void c() {
		s.clear();
		s.add(new adi(0, q / 2 - 100, r / 2 + 10 + offset, 98, 20, "Yes"));
		s.add(new adi(1, q / 2 + 2, r / 2 + 10 + offset, 98, 20, "No"));
